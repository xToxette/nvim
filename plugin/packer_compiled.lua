...
_G.packer_plugins = {
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/xtoxette/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
